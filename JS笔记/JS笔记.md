...
# JS进阶
## 一、作用域
作用域(scope)规定了变量能够被访问的“范围”，离开了这个范围变量便不能被访问
### 1、局部作用域
#### (1)函数作用域
![](./images/QQ截图20230918130909.png)  
#### (2)块作用域
![](./images/QQ截图20230918131226.png)  

### 2、全局作用域
![](./images/QQ截图20230918131333.png)  

### 3、作用域链
![](./images/QQ截图20230918131611.png)  

### 4、JS垃圾回收机制
![](./images/QQ截图20230918131925.png)  
![](./images/QQ截图20230918132027.png)  
#### (1)引用计数法(已不再使用)
![](./images/QQ截图20230918132545.png)
![](./images/QQ截图20230918132854.png)
#### (2)标记清除法
![](./images/QQ截图20230918133009.png)  

### 5、闭包(Closure)
#### (1)定义
![](./images/QQ截图20230918134146.png)
#### (2)作用以及基本使用
![](./images/QQ截图20230918134811.png)
#### (3)闭包应用-统计函数调用次数
![](./images/QQ截图20230918140530.png)  
#### (4)总结
![](./images/QQ截图20230918140617.png)

### 6、变量提升
![](./images/QQ截图20230918140910.png)  
![](./images/QQ截图20230918140956.png)

## 二、函数进阶
### 1、函数提升
![](./images/QQ截图20230918145424.png)

### 2、函数参数
#### (1)动态参数
![](./images/QQ截图20230918150210.png)
#### (2)剩余参数
![](./images/QQ截图20230918150356.png)
![](./images/QQ截图20230918150504.png)
![](./images/QQ截图20230918150550.png)
#### (3)展开运算符
![](./images/QQ截图20230918151129.png)  
![](./images/QQ截图20230918151030.png)  
...
// 3、只有一行代码时可以省略大括号
const fn4 = a => console.log(1)
fn4(1)

// 4、只有一行代码时可以省略return，直接返回值
const fn5 = x => x + x
console.log(fn5(1))
// 更简洁的语法
const form = document.querySelector('form')
form.addEventListener('click', ev => ev.preventDefault())    // ev是事件对象

// 5、箭头函数可以直接返回一个对象,对象的大括号会和函数的大括号冲突，可以将函数的大括号换成小括号
const fn = (uname) => ({ uname: uname })
console.log(fn('kang'))

```
![](./images/QQ截图20230918154351.png)


#### (2)箭头函数参数
![](./images/QQ截图20230918154718.png)
